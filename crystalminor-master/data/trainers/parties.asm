...
FalknerGroup:
	...
	db  8,  PIDGEY, 	LUCKY_EGG,	TACKLE, MUD_SLAP, GUST, NO_MOVE
	db 	8,  HOOTHOOT, SHARP_BEAK,	TACKLE, PECK, MUD_SLAP, FLASH
	db  10, NATU,			BERRY,			CONFUSION, MUD_SLAP, GUST, QUICK_ATTACK
	db -1 ; end
...
WhitneyGroup:
	...
	db 18, JIGGLYPUFF, SING, DISABLE, CHARM, PERISH_SONG
	db 20, MILTANK,    ROLLOUT, ATTRACT, STRENGTH, MILK_DRINK
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 14, LEDYBA,     TACKLE, SUPERSONIC, LIGHT_SCREEN, SAFEGUARD
	db 14, SPINARAK,   POISON_STING, SPIDER_WEB, FURY_CUTTER, DISABLE
	db 16, SCIZOR,     QUICK_ATTACK, LEER, FURY_CUTTER, CUT
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 22, HAUNTER,    HYPNOSIS, NIGHTMARE, CURSE, SHADOW_BALL
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 25, MISDREAVUS, SHADOW_BALL, MEAN_LOOK, SURF, PAIN_SPLIT
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 29, DEWGONG,		MINT_BERRY,		BODY_SLAM, ICY_WIND, WHIRLPOOL, REST
	db 31, SNEASEL, 	KINGS_ROCK,		SLASH, ICE_PUNCH, FAINT_ATTACK, ROCK_SMASH
	db 33, PILOSWINE,	NEVERMELTICE,	ICY_WIND, EARTHQUAKE, ROCK_SLIDE, BODY_SLAM
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 34, SKARMORY,	SPIKES, STEEL_WING, PURSUIT, DRILL_PECK
	db 33, MAGNETON,  LOCK_ON, ZAP_CANNON, TRI_ATTACK, THUNDER_WAVE
	db 37, STEELIX,   EARTHQUAKE, IRON_TAIL, ROCK_SLIDE, ROAR
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 32, PRIMEAPE,  FOCUS_BAND,	DYNAMICPUNCH, THUNDERPUNCH, FLY, BEAT_UP
	db 34, POLIWRATH,	KINGS_ROCK,	HYPNOSIS, MIND_READER, ICE_PUNCH, DYNAMICPUNCH
	db 36, HERACROSS,	BLACK_BELT,	MEGAHORN, DYNAMICPUNCH, DETECT, ROCK_SLIDE
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 40, DRAGONAIR,	DRAGON_SCALE,	DRAGONBREATH, THUNDERBOLT, ICE_BEAM, FLAMETHROWER
	db 39, ARBOK,			NO_ITEM,			DRAGONBREATH, SCARY_FACE, CRUNCH, IRON_TAIL
	db 40, GYARADOS,	SCOPE_LENS, 	WATERFALL, CRUNCH, EARTHQUAKE, RAIN_DANCE
	db 42, KINGDRA,		MIRACLEBERRY,	SURF, THUNDER, DRAGONBREATH, REST
	db -1 ; end
...
Rival1Group:
	...
	db 34, MAGNETON,   SWIFT, SPARK, SWAGGER, THUNDER_WAVE
	db 36, HAUNTER,    HAZE, MEAN_LOOK, CURSE, SHADOW_BALL
	db 38, SNEASEL,    ICE_PUNCH, QUICK_ATTACK, PURSUIT, FAINT_ATTACK
	db 38, MEGANIUM,   SYNTHESIS, PETAL_DANCE, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 36, HAUNTER,    HAZE, MEAN_LOOK, CURSE, SHADOW_BALL
	db 38, SNEASEL,    ICE_PUNCH, QUICK_ATTACK, PURSUIT, FAINT_ATTACK
	db 38, TYPHLOSION, SMOKESCREEN, SWIFT, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end

	; RIVAL1 (12)
	db "?@", TRAINERTYPE_MOVES
	db 36, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 34, MAGNETON,   SWIFT, SPARK, SONICBOOM, THUNDER_WAVE
	db 36, HAUNTER,    HAZE, MEAN_LOOK, CURSE, SHADOW_BALL
	db 38, SNEASEL,    ICE_PUNCH, QUICK_ATTACK, PURSUIT, FAINT_ATTACK
	db 38, FERALIGATR, SLASH, WHIRLPOOL, CRUNCH, SCARY_FACE
	db -1 ; end

	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 40, SNEASEL,    QUICK_ATTACK, ICE_PUNCH, FAINT_ATTACK, FURY_CUTTER
	db 42, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 41, MAGNETON,   THUNDERBOLT, SONICBOOM, THUNDER_WAVE, SWIFT
	db 41, KADABRA,    REFLECT, DISABLE, PSYBEAM, RECOVER
	db 41, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 44, MEGANIUM,   SYNTHESIS, PETAL_DANCE, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 41, KADABRA,    REFLECT, DISABLE, PSYBEAM, RECOVER
	db 41, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 44, TYPHLOSION, SMOKESCREEN, SHADOW_BALL, QUICK_ATTACK, FLAMETHROWER
	db -1 ; end
	...
	db 41, KADABRA,    REFLECT, DISABLE, PSYBEAM, RECOVER
	db 41, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 44, FERALIGATR, CRUNCH, WATERFALL, SCARY_FACE, SLASH
	db -1 ; end
...
WillGroup:
	...
	db 44, ESPEON,     QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db 43, WOBBUFFET,  COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db 43, EXEGGUTOR,  REFLECT, LEECH_SEED, EGG_BOMB, PSYCHIC_M
	db 44, SLOWKING,   CURSE, AMNESIA, BODY_SLAM, PSYCHIC_M
...
BrunoGroup:
	...
	db 45, PRIMEAPE,   CROSS_CHOP, FORESIGHT, BEAT_UP, ROCK_SLIDE
	...
	db 49, MACHAMP,    ROCK_SLIDE, FORESIGHT, VITAL_THROW, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_ITEM_MOVES
	db 46, UMBREON,   LEFTOVERS,    SAND_ATTACK, CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK
	db 48, SNEASEL,   KINGS_ROCK,   ICE_PUNCH, FAINT_ATTACK, ROCK_SMASH, QUICK_ATTACK
	db 48, MURKROW,   LUCKY_EGG,    QUICK_ATTACK, WHIRLWIND, PURSUIT, FAINT_ATTACK
	db 49, HOUNDOOM,  GOLD_BERRY,   ROAR, PURSUIT, FLAMETHROWER, CRUNCH
	db 50, TYRANITAR, BLACKGLASSES, ROCK_SLIDE, CRUNCH, EARTHQUAKE, IRON_TAIL
	db -1 ; end
...
KogaGroup:
	...
	db 45, VENOMOTH,   SUBSTITUTE, SLUDGE_BOMB, PSYCHIC_M, TOXIC
	db 44, VILEPLUME,  LEECH_SEED, TOXIC, GIGA_DRAIN, SHADOW_BALL
...
ChampionGroup:
	...
	db 48, SKARMORY,	 FOCUS_BAND,   SPIKES, STEEL_WING, WING_ATTACK, HYPER_BEAM
	db 50, GYARADOS,	 KINGS_ROCK,   FLAIL, CRUNCH, WATERFALL, HYPER_BEAM
	db 50, STEELIX,		 QUICK_CLAW,   DRAGONBREATH, IRON_TAIL, EARTHQUAKE, HYPER_BEAM
	db 51, AERODACTYL, SCOPE_LENS,   WING_ATTACK, CRUNCH, ROCK_SLIDE, HYPER_BEAM
	db 51, CHARIZARD,	 CHARCOAL,     FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
	db 54, DRAGONITE,	 BITTER_BERRY, FIRE_BLAST, SAFEGUARD, OUTRAGE, HYPER_BEAM
	db -1 ; end
...
BrockGroup:
	...
	db 61, SUDOWOODO,  FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HORN_DRILL
...
MistyGroup:
	...
	db 54, POLITOED,   SURF, RAIN_DANCE, THUNDER, HAZE
...
LtSurgeGroup:
	...
	db 48, MAGNETON,   LOCK_ON, DOUBLE_TEAM, LIGHT_SCREEN, ZAP_CANNON
	db 50, JOLTEON,    THUNDERBOLT, AGILITY, SHADOW_BALL, BATON_PASS
...
YoungsterGroup:
	...
	db 26, RATTATA,    CRUNCH, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 48, VICTREEBEL, NO_ITEM,      GIGA_DRAIN, TOXIC, SLUDGE_BOMB, RAZOR_LEAF
	db 48, KINGLER,    KINGS_ROCK,   SURF, STOMP, GUILLOTINE, BLIZZARD
	...
	db 39, URSARING,   DYNAMICPUNCH, BITE, SLASH, CUT
	db 41, GOLDUCK,    CONFUSION, SCREECH, PSYCH_UP, FURY_SWIPES
	db -1 ; end
	...
	db 39, EXEGGUTOR,  LEECH_SEED, CONFUSION, SLEEP_POWDER, SOLARBEAM
	db -1 ; end

	; COOLTRAINERM (12)
	db "BRIAN@", TRAINERTYPE_MOVES
	db 42, SANDSLASH,  SAND_ATTACK, POISON_STING, SLASH, SWIFT
	db 42, ARBOK,      GLARE, CRUNCH, IRON_TAIL, TOXIC
	db -1 ; end
	...
	db 41, DRAGONAIR,  WRAP, SURF, DRAGON_RAGE, SLAM
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 41, AMPHAROS,   THUNDER, DRAGONBREATH, ICE_PUNCH, COTTON_SPORE
	db -1 ; end
	...
	db 44, AMPHAROS,   IRON_TAIL, THUNDER, DRAGONBREATH, ICE_PUNCH
	db -1 ; end
	...
	db 47, AMPHAROS,   MAGNET,       THUNDER_WAVE, COTTON_SPORE, THUNDER, IRON_TAIL
	db -1 ; end
	...
	db 38, HORSEA,     SMOKESCREEN, LEER, WHIRLPOOL, TWISTER
	db 38, HORSEA,     SMOKESCREEN, LEER, WHIRLPOOL, TWISTER
...
PokemaniacGroup:
	...
	db 10, SLOWPOKE
	db 12, SLOWPOKE ; Slowpoke gives a lot of XP
	db -1 ; end
	...
	db 16, LICKITUNG,  LICK, SUPERSONIC, CUT, STOMP
	db -1 ; end
...
FisherGroup:
	...
	db 37, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_ATTACK
	db 37, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_ATTACK
	db 40, QWILFISH,   ROLLOUT, SURF, PIN_MISSILE, TAKE_DOWN
	db -1 ; end
...
SailorGroup:
	...
	db 29, KRABBY,     BUBBLE, LEER, VICEGRIP, HARDEN
	db 31, KINGLER,     BUBBLEBEAM, LEER, VICEGRIP, HARDEN
	db -1 ; end
...
HikerGroup:
	...
	db 37, DONPHAN,    MAGNITUDE, BITE, SAND_ATTACK, TACKLE
...
BlackbeltGroup:
	...
	db 32, HITMONLEE,  DOUBLE_KICK, MEDITATE, JUMP_KICK, FOCUS_ENERGY
	db -1 ; end

	; BLACKBELT_T (3)
	db "KENJI@", TRAINERTYPE_MOVES
	db 37, ONIX,       BIND, ROCK_THROW, TOXIC, DIG
	db 42, MACHAMP,    HEADBUTT, SWAGGER, THUNDERPUNCH, VITAL_THROW
	db 37, STEELIX,    EARTHQUAKE, ROCK_THROW, IRON_TAIL, SANDSTORM
	db 40, HITMONLEE,  DOUBLE_TEAM, HI_JUMP_KICK, MUD_SLAP, SWIFT
	db -1 ; end

	; BLACKBELT_T (4)
	db "LAO@", TRAINERTYPE_MOVES
	db 32, HITMONCHAN, MACH_PUNCH, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH
	db -1 ; end

	; BLACKBELT_T (5)
	db "NOB@", TRAINERTYPE_MOVES
	db 31, MACHOP,     FIRE_BLAST, FLAMETHROWER, KARATE_CHOP, SEISMIC_TOSS
	db 31, MACHOKE,    ICE_PUNCH, DYNAMICPUNCH, THUNDERPUNCH, ROCK_SLIDE
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 38, HOUNDOUR,   EMBER, ROAR, BITE, BEAT_UP
	db 38, WEEZING,    TACKLE, SLUDGE_BOMB, SMOKESCREEN, HAZE
	db 38, OCTILLERY,  OCTAZOOKA, ZAP_CANNON, FLAMETHROWER, SHADOW_BALL
	db 38, STEELIX,    EARTHQUAKE, ROCK_SLIDE, CRUNCH, FLAIL
	db 40, HOUNDOOM,   FLAMETHROWER, SLUDGE_BOMB, CRUNCH, SUPER_FANG
	db -1 ; end

	; EXECUTIVEM (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 35, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 38, WEEZING,    SLUDGE, TACKLE, SMOKESCREEN, SMOG
	db -1 ; end
...
PsychicGroup:
	...
	db 17, SLOWPOKE,   TACKLE, GROWL, WATER_GUN, TAIL_WHIP
...
PicnickerGroup:
	...
	; PICNICKER (26)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 47, CLEFAIRY,   METRONOME, ENCORE, MOONLIGHT, MINIMIZE
	db -1 ; end
...
ExecutiveFGroup:
	...
	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 29, ARBOK,      WRAP, GLARE, POISON_STING, CRUNCH
	db 29, GLOOM,      MEGA_DRAIN, SWEET_SCENT, SLEEP_POWDER, ACID
	db 31, MURKROW,    WING_ATTACK, PURSUIT, HAZE, NO_MOVE
	db -1 ; end
...
MysticalmanGroup:
	...
	db 33, HAUNTER,    SHADOW_BALL, HYPNOSIS, MEAN_LOOK, CURSE
	db 35, ELECTRODE,  LOCK_ON, SONICBOOM, THUNDER, ROLLOUT
	db -1 ; end
