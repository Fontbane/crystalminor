...
OlivineCityScientistScript:
	jumptextfaceplayer OlivineCityScientistText
...
OlivineCityScientistText:
	text "Hey, watch it, kid!"

	para "Something's buried"
	line "in the sand here!"

	para "I'm trying to find"
	line "it with a MAGNET."
